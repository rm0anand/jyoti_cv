...
\internHeading
  {XYZ Corporation}{New York, USA}{2022.03 - 2023.02}
\itemListStart
  \myItem{Led a team of 5 to develop AI-driven solutions for supply chain optimization.}
  \myItem{Implemented predictive models, improving delivery accuracy by 15\%.}
\itemListEnd

\internHeading
  {ABC Industries}{San Francisco, USA}{2021.01 - 2022.02}
\itemListStart
  \myItem{Streamlined manufacturing processes, reducing waste by 10\%.}
  \myItem{Designed and deployed IoT-based monitoring systems.}
\itemListEnd
}
